...
(define* (make-bellscoin-cross-toolchain target
                                       #:key
...
desirable for building bellscoin Core release binaries."
...
;; failure; see https://github.com/bellscoin/bellscoin/pull/27296.
  ...
  (let ((target (getenv "HOST")))
    (cond ((string-suffix? "-mingw32" target)
          ...
          ((string-contains target "-linux-")
           (list (make-bellscoin-cross-toolchain target)))
