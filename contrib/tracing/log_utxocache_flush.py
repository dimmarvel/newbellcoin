...
"""Example logging bellscoin Core utxo set cache flushes utilizing
    the utxocache:flush tracepoint."""

# USAGE:  ./contrib/tracing/log_utxocache_flush.py path/to/bellscoind
...
def main(bellscoind_path):
    ...
    b = BPF(text=program, usdt_contexts=[bellscoind_with_usdts])
