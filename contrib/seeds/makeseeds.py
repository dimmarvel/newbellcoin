#!/usr/bin/env python3
# Copyright (c) 2013-2022 The bellscoin Core developers
...
def parse_args():
    argparser = argparse.ArgumentParser(description='Generate a list of bellscoin node seed ip addresses.')
...
def main():
    ...
    # Filter out hosts with multiple bellscoin ports, these are likely abusive
