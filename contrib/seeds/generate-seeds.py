...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef BELLSCOIN_CHAINPARAMSSEEDS_H\n')
    g.write('#define BELLSCOIN_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the bellscoin network\n')
    ...
    g.write('#endif // BELLSCOIN_CHAINPARAMSSEEDS_H\n')
