...
def tree_sha512sum(commit='HEAD'):
    ...
    This is copied from github-merge.py. See https://github.com/bellscoin-core/bellscoin-maintainer-tools."""
...
def main():
    ...
    while True:
        ...
        os.environ['BELLSCOIN_VERIFY_COMMITS_ALLOW_SHA1'] = "0" if no_sha1 else "1"
