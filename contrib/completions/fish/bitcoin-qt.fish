...
complete --command bellscoin-qt --no-files

# Extract options
function __fish_bellscoinqt_get_options
...
complete \
    --command bellscoin-qt \
    --arguments "(__fish_bellscoinqt_get_options)"
# Enable file completions only if the commandline now contains a `*.=` style option
complete -c bellscoin-qt \
...
complete \
    --command bellscoin-qt \
    --arguments "(__fish_bellscoinqt_get_options --nofiles)"
