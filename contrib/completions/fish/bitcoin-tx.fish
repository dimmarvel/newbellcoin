...
# Extract options
function __fish_bellscoin_tx_get_options
...
# Extract commands
function __fish_bellscoin_tx_get_commands
...
# Add options
complete \
    --command bellscoin-tx \
    --condition "not __fish_bellscoin_seen_cmd (__fish_bellscoin_tx_get_commands --commandsonly)" \
    --arguments "(__fish_bellscoin_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command bellscoin-tx \
    --arguments "(__fish_bellscoin_tx_get_commands)" \
    --no-files
