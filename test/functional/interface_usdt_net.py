...
"""  Tests the net:* tracepoint API interface.
     See https://github.com/bellscoin/bellscoin/blob/master/doc/tracing.md#context-net
"""
...
class NetTracepointTest(BellscoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("connect a P2P test node to our bellscoind node")
