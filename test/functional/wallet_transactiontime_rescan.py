...
class TransactionTimeRescanTest(BellscoinTestFramework):
    ...
    def run_test(self):
        ...
        minernode = self.nodes[0]  # node used to mine BELLS and create transactions
        ...
        # generate some bells to create transactions and check blockcount
        ...
        # send 10 bells to user's first watch-only address
        self.log.info('Send 10 bells to user')
        ...
        # send 5 bells to our second watch-only address
        self.log.info('Send 5 bells to user')
        ...
        # send 1 bells to our third watch-only address
        self.log.info('Send 1 bells to user')
