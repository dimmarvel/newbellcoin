...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the BellscoinTestFramework
    pass


class ExampleTest(BellscoinTestFramework):
    # Each functional test is a subclass of the BellscoinTestFramework class.
    ...
    def custom_method(self):
        ...
        BellscoinTestFramework class so other tests can use it."""
