...
class TestShell:
    """Wrapper Class for BellscoinTestFramework.

    The TestShell class extends the BellscoinTestFramework
    ...
    class __TestShell(BellscoinTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by BellscoinTestFramework child class.
            self.num_nodes = 1
