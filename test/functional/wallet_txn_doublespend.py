...
class TxnMallTest(BellscoinTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 1,250 BELLS:
        ...
        # First: use raw transaction API to send 1240 BELLS to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 BELLS coin each
        ...
        # Node0's balance should be starting balance, plus 50BELLS for another
        ...
        # Node0's total balance should be starting balance, plus 100BELLS for
