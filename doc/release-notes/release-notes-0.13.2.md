bellscoin Core version 0.13.2 is now available from:

  <https://bellscoin.org/bin/bellscoin-core-0.13.2/>
...
- #8908 `4a974b2` Update bellscoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow bellscoin-tx to create v2 transactions (bellsdrak)
