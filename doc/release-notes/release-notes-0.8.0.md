bellscoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/bellscoin/files/bellscoin/bellscoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the bellscoin
...
New/changed settings (command-line or bellscoin.conf file)
--------------------------------------------------------
