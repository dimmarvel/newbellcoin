...
bellscoin Core version 0.19.1 is now available from:

  <https://bellscoincore.org/bin/bellscoin-core-0.19.1/>
...
From bellscoin Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as bellscoin Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, bellscoin Core does not yet change appearance when
...
- #17488 fix "bellscoind already running" warnings on macOS (fanquake)
