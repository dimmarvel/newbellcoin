bellscoin Core version 0.9.4 is now available from:

  https://bellscoin.org/bin/0.9.4/
...
this update is incompatible with the bellscoin system and could lead to consensus
forks.

bellscoin Core released binaries from https://bellscoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~bellscoin/+archive/ubuntu/bellscoin
- A third-party or self-compiled bellscoin Core

upgrade to bellscoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
