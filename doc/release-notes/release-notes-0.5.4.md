bellscoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/bellscoin/files/bellscoin/bellscoin-0.5.4/
...
http://gitorious.org/bellscoin/bellscoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix bellscoin-Qt notifications under Growl 1.3.
Increase required age of bellscoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxbellscoin properly when installing bellscoin-Qt over it. (Windows)
