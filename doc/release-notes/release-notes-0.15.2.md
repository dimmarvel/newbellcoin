bellscoin Core version *0.15.2* is now available from:

  <https://bellscoincore.org/bin/bellscoin-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in bellscoin-tx (TheBlueMatt)
