bellscoin version 0.7.0 is now available for download at:
  http://sourceforge.net/projects/bellscoin/files/bellscoin/bellscoin-0.7.0/

We recommend that everybody running prior versions of bellscoind/bellscoin-Qt
...
source-only tarballs/zipballs directly from there:
  https://github.com/bellscoin/bellscoin/tarball/v0.7.0  # .tar.gz
  https://github.com/bellscoin/bellscoin/zipball/v0.7.0  # .zip
...
Code:
/Applications/bellscoin-Qt
(on Mac) or
Code:
bellscoind/bellscoin-qt
(on Linux).
...
bellscoin Improvement Proposals implemented
...
Core bellscoin handling and blockchain database
...
* Ensure a changed bellscoin unit immediately updates all GUI elements that use units
...
* Bash programmable completion for bellscoind(1)
