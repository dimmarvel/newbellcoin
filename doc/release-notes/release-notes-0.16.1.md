bellscoin Core version 0.16.1 is now available from:

  <https://bellscoincore.org/bin/bellscoin-core-0.16.1/>
...
- #12843 `df38b13` Test starting bellscoind with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure bellscoind processes are cleaned up when tests end (sdaftuar)
