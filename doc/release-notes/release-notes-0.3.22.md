Download URL: https://sourceforge.net/projects/bellscoin/files/bellscoin/bellscoin-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 BELLS fee schedule (users still pay 0.01 BELLS per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #bellscoin00 - #bellscoin99
