bellscoin Core version 0.10.4 is now available from:

  <https://bellscoin.org/bin/bellscoin-core-0.10.4/>
...
- #6953 `43c2789` Split bellscoin-tx into its own package
- #6953 `dfe0d4d` Include bellscoin-tx binary on Debian/Ubuntu
