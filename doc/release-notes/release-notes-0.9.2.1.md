bellscoin Core version 0.9.2.1 is now available from:

  https://bellscoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 BELLS to 0.01 BELLS
...
- Fix "Start bellscoin on system login"
