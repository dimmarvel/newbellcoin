bellscoin Core version *0.15.0.1* is now available from:

  <https://bellscoin.org/bin/bellscoin-core-0.15.0.1/>

and

  <https://bellscoincore.org/bin/bellscoin-core-0.15.0.1/>
