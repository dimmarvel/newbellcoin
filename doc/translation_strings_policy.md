...
This document provides guidelines for internationalization of the bellscoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `bellscoin_en.ts` remains unchanged.
