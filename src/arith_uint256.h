...
#ifndef BELLSCOIN_ARITH_UINT256_H
#define BELLSCOIN_ARITH_UINT256_H
...
public:
     ...
     *
     * bellscoin only uses this "compact" format for encoding difficulty
...
#endif // BELLSCOIN_ARITH_UINT256_H
