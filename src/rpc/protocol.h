...
#ifndef BELLSCOIN_RPC_PROTOCOL_H
#define BELLSCOIN_RPC_PROTOCOL_H
...
enum RPCErrorCode
{
    ...
    // RPC_INTERNAL_ERROR should only be used for genuine errors in bellscoind
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  //!< bellscoin is not connected
...
#endif // BELLSCOIN_RPC_PROTOCOL_H
