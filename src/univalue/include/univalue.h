...
// Copyright 2015 bellscoin Core Developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or https://opensource.org/licenses/mit-license.php.

#ifndef BELLSCOIN_UNIVALUE_INCLUDE_UNIVALUE_H
#define BELLSCOIN_UNIVALUE_INCLUDE_UNIVALUE_H
...
#endif // BELLSCOIN_UNIVALUE_INCLUDE_UNIVALUE_H
