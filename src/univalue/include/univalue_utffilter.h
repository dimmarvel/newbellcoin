...
#ifndef BELLSCOIN_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H
#define BELLSCOIN_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H
...
#endif // BELLSCOIN_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H
