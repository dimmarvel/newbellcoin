...
#ifndef BELLSCOIN_WALLET_WALLET_H
#define BELLSCOIN_WALLET_WALLET_H
...
public:
     ...
     * bellscoin-wallet tool code or by wallet migration code. If this is called
...
#endif // BELLSCOIN_WALLET_WALLET_H
