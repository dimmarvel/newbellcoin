...
#ifndef BELLSCOIN_WALLET_SCRIPTPUBKEYMAN_H
#define BELLSCOIN_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The bellscoin Core wallet was originally a collection of unrelated private
...
#endif // BELLSCOIN_WALLET_SCRIPTPUBKEYMAN_H
