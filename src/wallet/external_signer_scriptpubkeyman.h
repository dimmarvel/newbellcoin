...
#ifndef BELLSCOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
#define BELLSCOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
...
#endif // BELLSCOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
