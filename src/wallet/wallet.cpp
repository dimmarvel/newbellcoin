...
CWalletTx* CWallet::AddToWallet(CTransactionRef tx, const TxState& state, const UpdateWalletTxFn& update_wtx, bool fFlushOnClose, bool rescanning_old_block)
{
    ...
    if (!strCmd.empty())
    {
        ...
        // https://github.com/bellscoin/bellscoin/pull/13339#issuecomment-537384875
        // A few ways it could be implemented in the future are described in:
        // https://github.com/bellscoin/bellscoin/pull/13339#issuecomment-461288094
...
bool CWallet::LoadToWallet(const uint256& hash, const UpdateWalletTxFn& fill_wtx)
{
    ...
    // If wallet doesn't have a chain (e.g when using bellscoin-wallet tool),
...
void CWallet::transactionRemovedFromMempool(const CTransactionRef& tx, MemPoolRemovalReason reason) {
    ...
    if (reason == MemPoolRemovalReason::CONFLICT) {
        ...
        //    https://github.com/bellscoin/bellscoin/pull/18600#discussion_r420195993.
        ...
        //    https://github.com/bellscoin/bellscoin/pull/9371 and the prior sync
        ...
        // https://github.com/bellscoin-core/bellscoin-devwiki/wiki/Wallet-Transaction-Conflict-Tracking
...
{
    LOCK(cs_wallet);
    WalletLogPrintf("CommitTransaction:\n%s", tx->ToString()); // NOLINT(bellscoin-unterminated-logprintf)
 ...
 * https://bellscointalk.org/?topic=54527, or
 * https://github.com/bellscoin/bellscoin/pull/1393.
 */
