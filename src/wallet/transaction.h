...
#ifndef BELLSCOIN_WALLET_TRANSACTION_H
#define BELLSCOIN_WALLET_TRANSACTION_H
...
public:
     ...
     * on this bellscoin node, and set to 0 for transactions that were created
...
#endif // BELLSCOIN_WALLET_TRANSACTION_H
