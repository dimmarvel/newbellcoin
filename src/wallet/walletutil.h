// Copyright (c) 2017-2021 The bellscoin Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef BELLSCOIN_WALLET_WALLETUTIL_H
#define BELLSCOIN_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! bellscoin from opening the wallet, thinking it was newly created, and
...
#endif // BELLSCOIN_WALLET_WALLETUTIL_H
