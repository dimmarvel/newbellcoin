...
#ifndef BELLSCOIN_POLICY_FEERATE_H
#define BELLSCOIN_POLICY_FEERATE_H
...
const std::string CURRENCY_UNIT = "BELLS"; // One formatted unit
...
enum class FeeEstimateMode {
    ...
    BELLS_KVB,      //!< Use BELLS/kvB fee rate unit
...
public:
    ...
    std::string ToString(const FeeEstimateMode& fee_estimate_mode = FeeEstimateMode::BELLS_KVB) const;
...
#endif // BELLSCOIN_POLICY_FEERATE_H
