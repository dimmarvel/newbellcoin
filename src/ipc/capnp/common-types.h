...
#ifndef BELLSCOIN_IPC_CAPNP_COMMON_TYPES_H
#define BELLSCOIN_IPC_CAPNP_COMMON_TYPES_H
...
//! Functions to serialize / deserialize common bellscoin types.
namespace mp {
...
#endif // BELLSCOIN_IPC_CAPNP_COMMON_TYPES_H
