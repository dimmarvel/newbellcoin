// Copyright (c) 2021-present The bellscoin Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef BELLSCOIN_UTIL_OVERLOADED_H
#define BELLSCOIN_UTIL_OVERLOADED_H
...
#endif // BELLSCOIN_UTIL_OVERLOADED_H
