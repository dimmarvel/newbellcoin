...
#ifndef BELLSCOIN_UTIL_MESSAGE_H
#define BELLSCOIN_UTIL_MESSAGE_H
 ...
 * @param[in] address Signer's bellscoin address, it must refer to a public key.
...
#endif // BELLSCOIN_UTIL_MESSAGE_H
