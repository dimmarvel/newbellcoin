...
#ifndef BELLSCOIN_INTERFACES_INIT_H
#define BELLSCOIN_INTERFACES_INIT_H
...
//! (bellscoin-gui, bellscoin-node, bellscoin-wallet, bellscoind, bellscoin-qt) and each
...
#endif // BELLSCOIN_INTERFACES_INIT_H
