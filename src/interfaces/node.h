...
#ifndef BELLSCOIN_INTERFACES_NODE_H
#define BELLSCOIN_INTERFACES_NODE_H
...
//! Top-level interface for a bellscoin node (bellscoind process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // BELLSCOIN_INTERFACES_NODE_H
