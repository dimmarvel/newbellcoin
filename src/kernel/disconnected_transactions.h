...
#ifndef BELLSCOIN_KERNEL_DISCONNECTED_TRANSACTIONS_H
#define BELLSCOIN_KERNEL_DISCONNECTED_TRANSACTIONS_H
...
#endif // BELLSCOIN_KERNEL_DISCONNECTED_TRANSACTIONS_H
