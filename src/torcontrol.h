// Copyright (c) 2015-2021 The bellscoin Core developers
 ...
 */
#ifndef BELLSCOIN_TORCONTROL_H
#define BELLSCOIN_TORCONTROL_H
...
/****** bellscoin specific TorController implementation ********/
