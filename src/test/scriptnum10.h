...
#ifndef BELLSCOIN_TEST_SCRIPTNUM10_H
#define BELLSCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from bellscoin Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // BELLSCOIN_TEST_SCRIPTNUM10_H
