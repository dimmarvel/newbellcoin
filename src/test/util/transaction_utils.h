// Copyright (c) 2019-2020 The bellscoin Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef BELLSCOIN_TEST_UTIL_TRANSACTION_UTILS_H
#define BELLSCOIN_TEST_UTIL_TRANSACTION_UTILS_H
...
#endif // BELLSCOIN_TEST_UTIL_TRANSACTION_UTILS_H
