...
{
    BOOST_CHECK(TestSplitHost("www.bellscoincore.org", "www.bellscoincore.org", 0));
    BOOST_CHECK(TestSplitHost("[www.bellscoincore.org]", "www.bellscoincore.org", 0));
    BOOST_CHECK(TestSplitHost("www.bellscoincore.org:80", "www.bellscoincore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.bellscoincore.org]:80", "www.bellscoincore.org", 80));
    ...
    BOOST_CHECK(TestSplitHost("www.bellscoincore.org:65536", "www.bellscoincore.org:65536", 0, false));
    BOOST_CHECK(TestSplitHost("www.bellscoincore.org:0", "www.bellscoincore.org", 0, false));
    BOOST_CHECK(TestSplitHost("www.bellscoincore.org:", "www.bellscoincore.org:", 0, false));
}
