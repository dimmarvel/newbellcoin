...
#ifndef BELLSCOIN_NODE_CONNECTION_TYPES_H
#define BELLSCOIN_NODE_CONNECTION_TYPES_H
 ...
 * src/qt/guiutil.cpp and src/bellscoin-cli.cpp::NetinfoRequestHandler. */
enum class ConnectionType {
     ...
     * Note that in the literature ("Eclipse Attacks on bellscoin’s Peer-to-Peer Network")
...
#endif // BELLSCOIN_NODE_CONNECTION_TYPES_H
