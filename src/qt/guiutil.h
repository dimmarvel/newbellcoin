...
#ifndef BELLSCOIN_QT_GUIUTIL_H
#define BELLSCOIN_QT_GUIUTIL_H
...
/** Utility functions used by the bellscoin Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "bellscoin:" URI into recipient object, return true on successful parsing
