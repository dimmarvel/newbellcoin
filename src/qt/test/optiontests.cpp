...
{
    // Test regression https://github.com/bellscoin/bellscoin/issues/24457. Ensure
...
{
    // Test that the bug https://github.com/bellscoin-core/gui/issues/567 does not resurface.
    // It was fixed via https://github.com/bellscoin-core/gui/pull/568.
    // With fListen=false in ~/.config/bellscoin/bellscoin-Qt.conf and all else left as default,
    // bellscoin-qt should set both -listen and -listenonion to false and start successfully.
