...
#ifndef BELLSCOIN_QT_SENDCOINSENTRY_H
#define BELLSCOIN_QT_SENDCOINSENTRY_H
...
/**
 * A single entry in the dialog for sending bellscoins.
 */
...
#endif // BELLSCOIN_QT_SENDCOINSENTRY_H
