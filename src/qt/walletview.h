...
#ifndef BELLSCOIN_QT_WALLETVIEW_H
#define BELLSCOIN_QT_WALLETVIEW_H
...
private:
    ...
    //!
    //! The wallet model represents a bellscoin wallet, and offers access to
...
#endif // BELLSCOIN_QT_WALLETVIEW_H
