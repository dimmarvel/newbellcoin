      ...
      ui(new Ui::OptionsDialog)
{
    ...
    ui->bellscoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->bellscoinAtStartup);
    ...
    ui->bellscoinAtStartup->setToolTip(ui->bellscoinAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->bellscoinAtStartup->setText(ui->bellscoinAtStartup->text().arg(PACKAGE_NAME));

    ui->openBellscoinConfButton->setToolTip(ui->openBellscoinConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new BellscoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->bellscoinAtStartup, OptionsModel::StartAtStartup);
    ...
    mapper->addMapping(ui->m_enable_psbt_controls, OptionsModel::EnablePSBELLSontrols);
...
void OptionsDialog::on_openBellscoinConfButton_clicked()
{
