...
The library primarily serves the needs of the bellscoin Core project but provides additional functionality for the benefit of the wider bellscoin ecosystem.
...
* **Relevance Arguments:**
    The relevance of the new functionality for the bellscoin ecosystem should be argued by outlining clear use cases.
...
The Contributor Workflow & Peer Review in libsecp256k1 are similar to bellscoin Core's workflow and review processes described in its [CONTRIBUTING.md](https://github.com/bellscoin/bellscoin/blob/master/CONTRIBUTING.md).
...
* Use `secp256k1_memcmp_var` instead of `memcmp` (see [#823](https://github.com/bellscoin-core/secp256k1/issues/823)).
