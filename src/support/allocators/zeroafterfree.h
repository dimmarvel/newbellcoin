...
#ifndef BELLSCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
#define BELLSCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
...
#endif // BELLSCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
